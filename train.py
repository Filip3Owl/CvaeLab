...
LATENT_DIM      = 128
DROPOUT         = 0.2
BETA_MAX        = 1.0      # peso máximo da KL
KL_WARMUP       = 25       # épocas para fazer annealing de β de 0 → BETA_MAX
AUGMENT         = True     # aumento de dados (flip + color jitter)
...
def main():
    ...
    parser.add_argument("--resume", type=str, default=None,
                        help="Caminho para um checkpoint vae_epochXXX.pt para retomar o treino")
    ...
    with mlflow.start_run() as run:
        ...
        for epoch in range(start_epoch, EPOCHS + 1):
            ...
            # Calcula β com annealing para esta época
